...
export default function WithdrawPage() {
  ...
  const handleWithdraw = async () => {
    ...
    alert(`Withdrawal request submitted:\n${withdrawAmount} ${selectedCoin.symbol}\nTo: ${address}`);
  };
              ...
              <div className={`rounded-xl p-6 ${isDark ? 'bg-gray-800' : 'bg-white'} shadow-sm border ${isDark ? 'border-gray-700' : 'border-gray-200'}`}>
                <div className="space-y-6">
                  ...
                  <button 
                    ...
                    className="w-full py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-colors duration-200 font-medium whitespace-nowrap cursor-pointer"
                  >
