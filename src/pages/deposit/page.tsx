...
const availableCoins: Coin[] = [
  {
    ...
    depositAddress: 'bc1qq7htvey2mjy7c8afq8cjtykkj3refpsl7v28n6',
  ...
  },
  {
    ...
    depositAddress: 'TNAreh2BzM8vLeHMquUY9Uti3ay7txR4nV',
    network: 'TRC20'
  },
  {
    symbol: 'ETH',
    ...
    depositAddress: '0xc19e2d388d8bb6faf821572c5fbee020e48a63de',
...
export default function DepositPage() {
  ...
  const handleCopyAddress = () => {
    if (selectedCoin?.depositAddress) {
      navigator.clipboard.writeText(selectedCoin.depositAddress).then(() => {
        setCopied(true);
              ...
              <div className={`rounded-xl p-6 ${isDark ? 'bg-gray-800' : 'bg-white'} shadow-sm border ${isDark ? 'border-gray-700' : 'border-gray-200'}`}>
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div>
                      <label className={`block text-sm font-medium mb-2 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                        {selectedCoin.symbol} Address {selectedCoin.network && `(${selectedCoin.network})`}
                      </label>
                      
                      <div className="relative">
                        <input
                          type="text"
                          value={selectedCoin.depositAddress}
                          readOnly
                          className={`w-full p-3 pr-24 border rounded-lg font-mono text-sm ${
                            isDark 
                        ...
                        <button 
                          ...
                          className="absolute right-2 top-1/2 transform -translate-y-1/2 px-4 py-1.5 bg-purple-600 hover:bg-purple-700 text-white text-sm rounded-md flex items-center space-x-1 cursor-pointer whitespace-nowrap transition-colors"
                        >
                  ...
                  <button 
                    ...
                    className="w-full py-3 rounded-lg transition-colors duration-200 font-medium whitespace-nowrap cursor-pointer bg-purple-600 hover:bg-purple-700 text-white"
                  >
                    Generate QR Code
                  </button>
                  ...
                  {showQR && (
                    <div className={`p-6 border rounded-lg ${isDark ? 'border-gray-600 bg-gray-700' : 'border-gray-300 bg-gray-50'} text-center`}>
                      ...
                      <div className="flex justify-center mb-4">
                        <img 
                          src={`https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(selectedCoin.depositAddress)}`}
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                        This address is unique to your account. Only send {selectedCoin.symbol} to this address.
                      </div>
                    </div>
                  </div>
                </div>
