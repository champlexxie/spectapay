        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              ...
              <span className="text-xl font-bold text-gray-900 dark:text-white">SPECTORX</span>
            </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-200 mb-8 max-w-3xl mx-auto leading-relaxed">
              Experience the future of cryptocurrency trading with SPECTORX. Advanced analytics, real-time market data, and secure transactions all in one powerful platform.
            </p>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-800 dark:to-purple-800">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 mb-8 leading-relaxed">
            Join thousands of traders who trust SPECTORX for their cryptocurrency investments.
          </p>
          <Link 
            to="/login" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center mb-4">
                ...
                <span className="text-xl font-bold">SPECTORX</span>
              </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 SPECTORX. All rights reserved.
            </p>
            <a 
