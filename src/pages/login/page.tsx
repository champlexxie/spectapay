...
export default function LoginPage() {
  ...
  }, [email, password, fullName, isSignUp, isFormValid, signIn, signUp, clearMessages, isSubmitting]);
  ...
  }, [signInWithGoogle, clearMessages, isSubmitting]);
        ...
        <div className="max-w-md mx-auto w-full">
          ...
          <div className="flex bg-gray-100 rounded-lg p-1 mb-6">
            <button
              ...
              className={`flex-1 py-3 px-4 rounded-md text-sm font-medium transition-all duration-150 cursor-pointer whitespace-nowrap disabled:opacity-50 ${
                !isSignUp
