...
serve(async (req) => {
  ...
  try {
    ...
    // Record transaction for sender (outgoing) - THIS IS THE KEY FIX
    ...
    // Record transaction for recipient (incoming) - THIS IS THE KEY FIX
    ...
    // Record in internal_transfers table for backup tracking
